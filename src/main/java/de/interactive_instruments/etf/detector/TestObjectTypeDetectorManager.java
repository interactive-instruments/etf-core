...
public class TestObjectTypeDetectorManager {
     ...
     * @throws TestObjectTypeNotDetected
     *             if the type was modified but cannot be detected anymore
     */
    ...
    /**
     * Returns a {@link DetectedTestObjectType} if the resource exactly matches the Test Object Type or a sub type of the detected Test Object Type. Otherwise an exception
     *
     * @param resource
     *            resource the TestObjectTypeDetector must use for retrieving and analyzing content
     * @param expectedTypes
