...
public interface WriteDao<T extends Dto> extends Dao<T> {
     ...
     *
     * If the new ID parameter is null, the ID is not changed -except for a Dto that is an instance of {@link RepositoryItemDto}, for which the updated Dto with a NEW EID is returned.
     *
     * @param dto
     *            old dto
     * @param newId
