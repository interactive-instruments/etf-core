...
/**
 * TranslationTemplateBundleDto represents a bundle of {@link LangTranslationTemplateCollectionDto} that can be accessed through its name.
 *
...
public class TranslationTemplateBundleDto extends ModelItemDto<TranslationTemplateBundleDto> {
    ...
    /**
     * Maps a named {@link LangTranslationTemplateCollectionDto#name} to a language specific collection {@link LangTranslationTemplateCollectionDto}
     */
