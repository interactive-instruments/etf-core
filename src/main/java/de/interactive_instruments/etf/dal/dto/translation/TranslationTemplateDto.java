...
/**
 * A named object that holds a string which may contain one or multiple tokens in a specific language. A Translation Template is used to translate messages.
 *
