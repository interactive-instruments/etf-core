...
public interface TaskState {
	...
	enum STATE {
		...
		/**
		 * The task completed and is now finalized
		 * by a managing object.
		 *
		 * Final state
		 */
		FINALIZING(37),
		...
		/**
		 * Returns true if the task completed (not a final state)
		 * failed (final) or canceled (final)
		 * @return true if in a final state
		 */
