...
&copy; 2017-2019 European Union, interactive instruments GmbH. Licensed under the EUPL.
...
This fork of the ETF component [etf-core](https://github.com/etf-validator/etf-core) is used by interactive instruments to implement and test new features before they are merged back into the master branch.
